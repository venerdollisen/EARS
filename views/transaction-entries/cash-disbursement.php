...
function addAccountRow() {
    ...
    row.innerHTML = `
        ...
        <td>
            <input type="number" class="form-control debit-amount" name="accounts[${currentRowIndex}][debit]" step="0.01" min="0" placeholder="0.00" onchange="calculateTotals()">
        </td>
        <td>
            <input type="number" class="form-control credit-amount" name="accounts[${currentRowIndex}][credit]" step="0.01" min="0" placeholder="0.00" onchange="calculateTotals()">
        </td>
        <td>
