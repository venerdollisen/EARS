        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title">Check Disbursement Report</h4>
                    <p class="card-text">Generate and view check disbursement reports with filtering options</p>
                </div>
                <div class="card-body">
                    <!-- Filters Section -->
                    <div class="row mb-4">
...
function displayReportData(response) {
    if (response.data && response.data.length > 0) {
        ...
        // Display charts
        if (response.byBank && response.byBank.length > 0) {
            createBankChart(response.byBank);
        }
        ...
        response.data.forEach(function(row) {
            ...
            tr.append('<td>' + (row.check_number || '') + '</td>');
